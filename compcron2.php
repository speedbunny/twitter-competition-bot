...
if (trim(substr($tweet_desc,0,2)) == "RT"){
$checksum = 23;
echo $checksum;
}
...
$bad  = array('USA','Cleveland','Sydney','Melbourne','Baltic','America','Santa Ana','India','Toronto','Illinois','New York','Chicago','Los Angeles','Las Vegas','Nevada','Kansas','Austrailia','New Zealand');
...
echo "You have followed ".$c." new people.";
}
}
}
}
