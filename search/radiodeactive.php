...
$originals = array();
$pointer = file_get_contents('rpointer.txt');
$namefile = file_get_contents('rchunk'.$pointer.'.txt');
$goodn = explode(",",$namefile);

//get the master names file chunk it to see how many chunks

$pointercalc = file_get_contents('radiodeactive.txt');
...
//BamBamBoomas Auth
$connection = new TwitterOAuth('9rL8nRR8oUREmceWvLqhQq57M', 'rgabKFtegC4IF0Wc8usUdvPkz72uznDb4wl9zZCUcbB7T4tJE6','202792995-YYG2UaQygCaPDrf7cd9FhhTVRsIGX6AVxN9POs5v', '7k6roDxHnXTifXf3GyrijwPDDYjT7sCL6yZnUL6k1XIlZ');
...
$twitcomp = array("RT to","RT and","Retweet and","Follow and","RT&","RT+","re tweet","RT to win", "RT and follow","RT ","RT + Follow","RT & Follow","Retweet & Follow","RT and FOLLOW","Re-Tweet","Follow &","#RT +");
if(strposa($tweet_desc, $twitcomp)===true){ //open
echo "<br>Looks like a Twitter Comp!<br>";
$teens = array("solo","gun","5SOS","fam","5/5","Niall","robux","DOTA", "MTVHottest","vote","Teenchoice","Ora","notifications","1D");
$babies = array("baby","nappies","babies","change","children","pregnancy","Pampers");
$pets = array("dog","rabbit");
$sports = array("#RJJLegend","StudioCanalUK","Atkins","JavaJohnZ","HerNextRemedy","@PamperPoint","Tailgate","#WipesWednesday","GiddySprite","Stick_in_there","MrDalekJD","#BlackCat","#NewMom","#NewBaby","The_BlueCrab","MATCH REPORT","Congratulations","6,500");
...
if (in_array($orig_desc, $oldor)) {
    echo "<br>Tweet text matches previous tweet ".$st."<br>";
$already = true;
} else
$already = false;
}
